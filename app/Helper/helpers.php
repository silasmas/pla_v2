...
if (!function_exists('checkFileInDirectory')) {
    function checkFileInDirectory($directory, $filename)
    {
        // Assurez-vous que le chemin du dossier se termine par un slash
        ...
        if (file_exists($filePath)) {
            return [
                'exists' => true,
                'message' => "Le fichier '$filename' existe dans le dossier '$directory'.",
                'path' => $filePath
            ];
        } else {
            return [
                'exists' => false,
                'message' => "Le fichier '$filename' n'existe pas dans le dossier '$directory'.",
                'path' => null
            ];
        }
    }
